...
from src.trainer.pooled_trainer import PooledTrainer


def main():
    parser = argparse.ArgumentParser(
        description="Baseline: pooled-CE family (shared classifier, no routing)")
    parser.add_argument("--model", default="bert-base-uncased")
    parser.add_argument("--model_name", default="baseline_pooled")
    parser.add_argument("--tasks", nargs="+", default=["MRPC", "RTE", "COLA"])
    parser.add_argument("--loss_type", choices=["ce", "gce", "bootstrapping", "hld"],
                        default="ce",
                        help="Pooled training loss family.")
    ...
    parser.add_argument("--out_dir", default="results/baseline_pooled")
