...
from src.trainer.task_identity_trainer import MTDNNTaskIdentityTrainer


def main():
    parser = argparse.ArgumentParser(
        description="Baseline: MT-DNN + softmax task-identification head")
    parser.add_argument("--model", default="bert-base-uncased")
    parser.add_argument("--model_name", default="baseline_task_identity")
    ...
    parser.add_argument("--out_dir", default="results/m1/task_identity")
    ...
    trainer = MTDNNTaskIdentityTrainer(
