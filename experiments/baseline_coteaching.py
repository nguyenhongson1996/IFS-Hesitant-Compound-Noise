...
from src.trainer.coteaching_trainer import CoteachingTrainer


def main():
    parser = argparse.ArgumentParser(
        description="Baseline: Co-teaching (class-label small-loss selection)")
    parser.add_argument("--model", default="bert-base-uncased")
    parser.add_argument("--model_name", default="baseline_coteaching")
    ...
    parser.add_argument("--out_dir", default="baseline_coteaching")
