...
from src.trainer.noisy_mtl_evidential_trainer import NoisyMTLEvidentialTrainer


def main():
    parser = argparse.ArgumentParser(
        description="BERT-scale faithful Sensoy 2018 binary evidential baseline")
    parser.add_argument("--model", default="bert-base-uncased")
    parser.add_argument("--model_name", default="evidential_bert")
    ...
    parser.add_argument("--kl_anneal_epochs", type=int, default=10,
                        help="Sensoy 2018: anneal kl_lambda 0->1 across this "
                             "many epochs. 0 disables KL term.")
    ...
    parser.add_argument("--lambda_other", type=float, default=1.0,
                        help="Unused (CLI compat); the binary evidential loss "
                             "has no IFS barrier term.")
    parser.add_argument("--out_dir", default="evidential_bert_out")
    ...
    trainer = NoisyMTLEvidentialTrainer(
